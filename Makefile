...
EXECS = $(BIN_DIR)/prog_sys $(BIN_DIR)/wc $(BIN_DIR)/mini_cat $(BIN_DIR)/mini_clean $(BIN_DIR)/mini_cp $(BIN_DIR)/mini_echo $(BIN_DIR)/mini_grep $(BIN_DIR)/mini_head $(BIN_DIR)/mini_tail $(BIN_DIR)/mini_touch
